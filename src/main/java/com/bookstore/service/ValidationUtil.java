...
public class ValidationUtil {
    ...
    // This pattern focuses on SQL metacharacters and comment syntax rather than
    // keywords
    ...
    private static final Pattern PASSWORD_SPECIAL_PATTERN = Pattern
            .compile(".*[!@#$%^&*()_+\\-=\\[\\]{};':\"\\\\|,.<>/?].*");
     ...
     * Requires: at least 8 characters, one uppercase, one lowercase, one digit, one
     * special character
     * 
     ...
     * Note: Empty or null keywords are considered invalid and should be handled by
     * the caller
     * 
     * @param keyword the search keyword to validate
     * @return true if keyword is valid (not null/empty, within length limit, and no
     *         malicious patterns), false otherwise
     */
